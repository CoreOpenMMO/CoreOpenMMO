...
namespace COTS.GameServer.World {
    ...
    public static partial class ImmutableWorldLoader {
        ...
        public static ImmutableWorld ParseWorld(byte[] serializedWorldData) {
        ...
        private static ImmutableWorld ConvertParsingTree(byte[] serializedWorldData, ParsingWorldNode root) {
            if (serializedWorldData == null)
                throw new ArgumentNullException(nameof(serializedWorldData));
            if (root == null)
            ...
            var world = new ImmutableWorld(worldRoot);
            return world;
        }

        private static ImmutableWorldNode ConvertingParsingNode(byte[] serializedWorldData, ParsingWorldNode subtree) {
            ...
            var immutableChildren = ReadOnlyArray<ImmutableWorldNode>.WrapCollection(childen);            

            var worldNode = new ImmutableWorldNode(
                props: propsSegment,
