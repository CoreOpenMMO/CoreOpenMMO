...
namespace COMMO.GameServer {
	...
	public readonly struct Position : IEquatable<Position> {
		...
		/// <summary>
		/// Creates a new <see cref="Position"/> whose coordinates are equal to this instance's
		/// plus the provided offesets.
		/// </summary>
		public Position Translate(int xOffset, int yOffset) => Translate(xOffset: xOffset, yOffset: yOffset, zOffset: Z);

		/// <summary>
		/// Creates a new <see cref="Position"/> whose coordinates are equal to this instance's
		/// plus the provided offesets.
		/// </summary>
		public Position Translate(int xOffset, int yOffset, int zOffset) {
			return new Position(
				x: X + xOffset,
				y: Y + yOffset,
				z: Z + zOffset);
